...
/**
 * This class tests the GameState class for the wrapping case and its methods.
 */
public class GameStateWrappingTest {
  ...
  private void initialize() {
    ...
    gameState = new GameState(7, 10, 50, 20.5, true, random);
  ...
  @Test public void testGameState() {
    ...
    assertThrows(IllegalArgumentException.class,
        () -> new GameState(-2, 2, 3, 20.0, true,  random));
    assertThrows(IllegalArgumentException.class,
        () -> new GameState(5, 5, 3, 20.0, true,  random));
    assertThrows(IllegalArgumentException.class,
        () -> new GameState(4, 6, 3, 20.0, true,  random));
    assertThrows(IllegalArgumentException.class,
        () -> new GameState(2, -3, 3, 30.0, true, random));
    assertThrows(IllegalArgumentException.class,
        () -> new GameState(3, 3, -3, 20.5, true, random));
    assertThrows(IllegalArgumentException.class,
        () -> new GameState(3, 3, 3, -30.0, true, random));
    assertThrows(IllegalArgumentException.class,
        () -> new GameState(3, 3, 4, 12.5, true, null));
  }
  ...
  @Test public void testIsGameOver() {
    ...
    GameState gameState1 = new GameState(7, 10, 100, 20.5, true, random);
  ...
  @Test public void testMovePlayer() {
    Random random = new Random(12);
    GameState gameState1 = new GameState(10, 10, 12, 20.5, true, random);
  ...
  @Test public void testInterconnectivity() {
    initialize();
    GameState gameStateNoConnectivity = new GameState(10, 10, 0, 20.5, true, random);
    GameState gameStateConnectivity = new GameState(10, 10, 2, 20.5, true, random);
  ...
  @Test public void testPickingTreasure() {
    ...
    assertEquals("Current Location: Row: 4 Column: 4 Treasures: {}",
        gameState.toStringStatus());
    gameState.movePlayer(Direction.EAST);
    assertEquals("Current Location: Row: 4 Column: 5 Treasures: {DIAMONDS=1}",
        gameState.toStringStatus());
  }
